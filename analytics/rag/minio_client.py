...
class MinioClient:
    ...
    def download_all_files(self, bucket_name, download_dir):
        try:
            ...
            objects = self.client.list_objects(bucket_name,prefix="mts/moskva_mts_ru", recursive=True)
            logger.info(objects)
            for obj in objects:
...
if __name__ == "__main__":
    minio_client = MinioClient("s3.larek.tech", "I3gAX8ygZF1pnXuSSo00", "ah2d805PcxU0PxYj0uhLzrasDnsgPi2xFGycpDm8")
