import { LoginParams, LoginResponse, SignUpParams } from '@/api/models';
...
export function AuthProvider({ children }: { children: ReactNode }) {
    ...
    const signup = async (params: SignUpParams, callback: VoidFunction) => {
        const response = await AuthApiService.signup(params);
        setUser(response);
        callback();
